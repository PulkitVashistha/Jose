 ...
 */
MapTo('Jose/components/navigation')(NavigationV1Component, {isEmpty: NavigationV1IsEmptyFn});
MapTo('Jose/components/separator')(SeparatorV1Component);

MapTo('Jose/components/container')(ContainerV1Component, {isEmpty: ContainerIsEmptyFn});
MapTo('Jose/components/experiencefragment')(ContainerV1Component, {isEmpty: ContainerIsEmptyFn});

MapTo('Jose/components/download')(DownloadV1Component,{isEmpty: DownloadV1IsEmptyFn});
MapTo('Jose/components/languagenavigation')(LanguageNavigationV1Component);
MapTo('Jose/components/list')(ListV2Component, {isEmpty: ListV2IsEmptyFn});
MapTo('Jose/components/breadcrumb')(BreadCrumbV2Component, {isEmpty: BreadCrumbV2IsEmptyFn});
MapTo('Jose/components/button')(ButtonV1Component, {isEmpty: ButtonV1IsEmptyFn});
MapTo('Jose/components/image')(ImageV2Component, {isEmpty: ImageV2IsEmptyFn});
MapTo('Jose/components/title')(TitleV2Component, {isEmpty: TitleV2IsEmptyFn});

MapTo('Jose/components/accordion')(AccordionV1Component);
MapTo('Jose/components/tabs')(TabsV1Component);
...
LazyMapTo('Jose/components/teaser')(TeaserV1Component);
...
LazyMapTo('Jose/components/carousel')(CarouselV1Component);
...
LazyMapTo('Jose/components/text')(LazyTextModule, TextEditConfig);